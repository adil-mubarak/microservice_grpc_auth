...
type AuthServiceClient interface {
	...
	ValidateToken(ctx context.Context, in *ValidateTokenRequest, opts ...grpc.CallOption) (*AuthResponse, error)
}
...
func (c *authServiceClient) ValidateToken(ctx context.Context, in *ValidateTokenRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
type AuthServiceServer interface {
	...
	ValidateToken(context.Context, *ValidateTokenRequest) (*AuthResponse, error)
...
func (UnimplementedAuthServiceServer) ValidateToken(context.Context, *ValidateTokenRequest) (*AuthResponse, error) {
